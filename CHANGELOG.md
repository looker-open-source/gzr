...
## [0.3.0](https://github.com/looker-open-source/gzr/compare/v0.3.17...v0.3.0) (2024-07-19)
...
* Add release please workflow to automate releases ([6279bc6](https://github.com/looker-open-source/gzr/commit/6279bc68fcfd8f09f7385053767e6a9571570333))
...
* Avoid API 4.0 for deprecation of spaces endpoint ([#124](https://github.com/looker-open-source/gzr/issues/124)) ([#125](https://github.com/looker-open-source/gzr/issues/125)) ([3823399](https://github.com/looker-open-source/gzr/commit/38233991bfc5456ac0cf3d485d12520f50a2ea76))
* Bump version ([652486c](https://github.com/looker-open-source/gzr/commit/652486ce6571d4fea2d3ea847c5927395aa4373e))
...
* detect if dashboard import gets a look file and vice versa, warn on importing a deleted dashboard or look ([#116](https://github.com/looker-open-source/gzr/issues/116)) ([a12dc25](https://github.com/looker-open-source/gzr/commit/a12dc2525bed55816b368306f2d05a24dc07aaf4))
* Faraday 2.x ([bdc5e52](https://github.com/looker-open-source/gzr/commit/bdc5e5205c1be21d76b93624f193fadb8a1b32b3))
* fix for release 0.2.55 ([3e2e4bd](https://github.com/looker-open-source/gzr/commit/3e2e4bdfdc35018449b3c6be6a6610f44ae865f7))
* fix version ([#121](https://github.com/looker-open-source/gzr/issues/121)) ([f9b0b22](https://github.com/looker-open-source/gzr/commit/f9b0b2237eb3c520aabc2f1ff5a63ddf6c934ce4))
* Gemfile.lock was out of date ([a4e49c3](https://github.com/looker-open-source/gzr/commit/a4e49c3972772e0629a8f1589172ddd136ee7e21))
* migrate to API 4.0 ([#154](https://github.com/looker-open-source/gzr/issues/154)) ([eecdfd4](https://github.com/looker-open-source/gzr/commit/eecdfd41a886f2edbac528a34f83dc7a6ea83f74))
...
* quick typo fixes for API 4.0 changes ([#168](https://github.com/looker-open-source/gzr/issues/168)) ([82a634e](https://github.com/looker-open-source/gzr/commit/82a634e77de0aaee5bd62c84092e827a2f7f6c73))
* refactored look and dashboard cat commands and space export to use the same code to generate each look and dashboard file. ([#114](https://github.com/looker-open-source/gzr/issues/114)) ([8dadd50](https://github.com/looker-open-source/gzr/commit/8dadd500376e2b971c38dbcd69f507268a3e6b9e))
* release version ([c94373c](https://github.com/looker-open-source/gzr/commit/c94373ce0677b4bd86e525f6a7e15b0204cb69fe))
...
* remove Thor deprecation warning ([#115](https://github.com/looker-open-source/gzr/issues/115)) ([1100c5a](https://github.com/looker-open-source/gzr/commit/1100c5a24b0626c01c6248d87172c7ab624bf42f))
* resolved warnings in gemspec. Improved handling of live tests ([6291147](https://github.com/looker-open-source/gzr/commit/6291147a09f55ed095d718a7a998d5af09b716e3))
* revert release to v2 ([4e0276b](https://github.com/looker-open-source/gzr/commit/4e0276bbb9427ed97b942ae57ac26b8a8252021d))
* temporary fix for faraday 2.x in looker-sdk ([acdb7e8](https://github.com/looker-open-source/gzr/commit/acdb7e8a174cd3dde5d8c95c95e572ec331b948f))
* temporary fix for faraday 2.x in looker-sdk ([#159](https://github.com/looker-open-source/gzr/issues/159)) ([d89f813](https://github.com/looker-open-source/gzr/commit/d89f8138587c2986352be25b59bda79d07ea2bb4))
...
* version number ([#119](https://github.com/looker-open-source/gzr/issues/119)) ([b55a892](https://github.com/looker-open-source/gzr/commit/b55a892d8d040ce4547924d613a590877e129322))
...
* release 0.2.49 ([14001fc](https://github.com/looker-open-source/gzr/commit/14001fcb8d10096ee2de15f85ac6e2b828be0e90))
