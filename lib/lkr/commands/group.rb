    ...
    class Group < SubCommandBase
      ...
      def member_users(group_id)
        if options[:help]
          ...
          Lkr::Commands::Group::MemberUsers.new(group_id,options).execute
        end
      end
      ...
      def member_groups(group_id)
        if options[:help]
          ...
          Lkr::Commands::Group::MemberGroups.new(group_id,options).execute
        end
      end
      ...
      def ls(*)
        if options[:help]
          ...
          Lkr::Commands::Group::Ls.new(options).execute
        end
      end
    end
  end
